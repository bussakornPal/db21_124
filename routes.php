<?php
$controllers=array('pages'=>['home','error'],'laboratory'=>['index','newLaboratory','addLaboratory','search','updateForm','update','deleteConfirm','delete'],'staff_in_lab'=>['index','newStaff_in_lab','addStaff_in_lab','search','updateForm','update','deleteConfirm','delete'],'RTPCR_test'=>['index','search','newRTPCR_test','addRTPCR_test','updateForm','update']);

function call($controller,$action){
    require_once("./controllers/".$controller."_controller.php");
    switch($controller)
    {
        case "pages":    require_once('./models/homeModel.php');
